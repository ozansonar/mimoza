        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info alert-dismissible">
                        <h5><i class="icon fas fa-info"></i> Dikkat !</h5>
                        Mailingde resim kullanacaksanız lütfen resmi bu kısımdan yükleyerek kullanının. Resmi yüklediğinde linki ekrana yazılacaktır.
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" method="post" id="mailingForm">
                        ...
                        ?>
                        <div class="col-12 p-0" id="attachment_upload_result" style="<?php echo isset($attachment_array) && !empty($attachment_array) ? null : "display: none;"; ?>">
                            <?php
                        ...
                        <div class="row p-2">
                            ...
                            <?php foreach($systemAdminUserType as $user_key=> $user_value): ?>
                                <?php if($user_key == 999){continue;} ?>
                                <div class="col-4 form-group icheck-primary d-inline">
                                    <input type="checkbox" class="form-check-input user_checkbox" name="user[<?php echo $user_key; ?>]"  value="<?php echo $user_key; ?>" id="id_user_<?php echo $user_key; ?>">
                                    <label class="form-check-label" for="id_user_<?php echo $user_key; ?>"><?php echo $user_value["form_text"]; ?></label>
                                </div>
                            <?php endforeach ?>
                        </div>
                        <div class="alert alert-info alert-dismissible">
                            <h5><i class="icon fas fa-info"></i> Dikkat !</h5>
                            Deneme maili göndermek istiyorsanız aşağıda ki alana gerekli bilgileri yazınız birden fazla adrese gitmesini istiyorsanızda "Ekle" diyerek ekleyebilirsiniz.
                        </div>
                                ...
                                <?php else: ?>
                                    <div class="border my-1 p-2 test-user-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="user_test[1][surname]" id="id_1_surname">
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                ...
                <div class="card-footer text-right">
                    <?php
                    echo $form->button("mailing_save",array(
                        "text" => "Kaydet",
                        "icon" => "fas fa-save",
            ...
            $("form#mailingForm").validationEngine('attach', {
                ...
                onValidationComplete: function(form, status){
                    if(status == true){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo $adminSystem->adminUrl("ajax/mailing-save"); ?>",
                            data: data,
