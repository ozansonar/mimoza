                ...
                <div class="card text-white bg-success">
                    ...
                    <div class="card-body">
                        <p class="card-text"><span
                                    class="font-weight-bold"><?php echo $functions->dateLong($data->created_at) ?></span>
                            tarihinde
                            <sapn class="font-weight-bold"><?php echo $data->name . " " . $data->surname ?></sapn>
                            tarafından gönderildi.
                        </p>
						<?php if (!empty($readUser)): ?>
                            <p class="card-text"><span
                                        class="font-weight-bold"><?php echo $functions->dateLong($data->read_date) ?></span>
                                tarihinde
                                <sapn class="font-weight-bold"><?php echo $readUser->name . " " . $readUser->surname ?></sapn>
                                tarafından okundu.
                            </p>
						<?php endif; ?>
						<?php if (!empty($data->reply_send_user_id)): ?>
                            ...
                            <p class="card-text"><span
                                        class="font-weight-bold"><?php echo $functions->dateLong($data->reply_send_date) ?></span>
                                tarihinde
                                <sapn class="font-weight-bold"><?php echo $reply_user->name . " " . $reply_user->surname ?></sapn>
