...
if(isset($_POST["submit"]) && $_POST["submit"] == 1){
    ...
    foreach ($projectLanguages as $project_languages_row){
        ...
        if($project_languages_row->form_validate == 1){
            ...
            if($pageData[$project_languages_row->short_lang]["show_type_control"] == false){
...
$data->pageButtonRedirectLink = "content-categories";
$data->pageButtonRedirectText = "Kategoriler";
